...
export class DevalueError extends Error {
  // Property declarations added for TypeScript: constructor-assignment
  // inference only applies to JS files, and consumers read these fields.
  declare path: string;
  declare value: any;
  declare root: any;
