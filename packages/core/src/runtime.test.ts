...
async function runWorkflowHandlerWithEvents(
  ...
  setWorld({
    ...
    // Present so the deployment guard treats this as a world with atomic
    // deployments (world-vercel); local/postgres worlds omit it and skip.
    resolveLatestDeploymentId: vi.fn(async () => workflowRun.deploymentId),
